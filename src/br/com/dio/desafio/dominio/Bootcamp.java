...
public class Bootcamp {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((desvInscritos == null) ? 0 : desvInscritos.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (dataFinal == null) {
            ...
            return false;
        if (desvInscritos == null) {
            if (other.desvInscritos != null)
                return false;
        } else if (!desvInscritos.equals(other.desvInscritos))
            return false;
        if (conteudos == null) {
